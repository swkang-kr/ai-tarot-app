...
export default function BottomNav() {
  ...
  return (
    <nav className="fixed left-0 right-0 z-50 bg-[#1a1744]/90 backdrop-blur-xl border-t border-white/10" style={{ bottom: 'var(--ad-banner-height, 0px)', paddingBottom: 'env(safe-area-inset-bottom, 0px)' }}>
