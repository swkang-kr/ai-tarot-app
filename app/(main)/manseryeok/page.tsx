...
import ManseryeokCard from '@/components/ManseryeokCard'
  ...
  const handleSubmit = useCallback(async () => {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        throw new Error(d.error || '만세력 분석에 실패했습니다')
      }
        ...
        <AnimatePresence mode="wait">
            ...
            >
              <div className="bg-white/10 backdrop-blur-lg rounded-3xl p-8 shadow-2xl">
                <div className="text-center mb-7">
                  ...
                  <h1 className="text-2xl font-bold text-white mb-1">만세력 분석</h1>
                  <p className="text-teal-300 text-sm">대운·세운·월운으로 삶의 흐름을 읽습니다</p>
                </div>
                ...
                <div className="mb-6">
                  ...
                  <select
                    ...
                    className="w-full bg-white/10 border border-white/20 text-white rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-teal-400 appearance-none"
                  >
                ...
                <motion.button
                  ...
                  disabled={!birthDate}
                  className="w-full bg-gradient-to-r from-teal-500 to-cyan-500 text-white py-4 rounded-xl font-semibold text-lg shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  📜 만세력 분석 시작
                </motion.button>
              </div>
          ...
          {step === 'result' && result && (
            ...
            >
              ...
              <ManseryeokCard analysis={result} targetYear={targetYear} />
              <motion.div
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
