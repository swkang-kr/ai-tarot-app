      ...
      <div className="max-w-md mx-auto space-y-6">
        <div className="bg-white/10 backdrop-blur-lg rounded-3xl p-8">
          ...
          <div className="space-y-6 text-white/80 text-sm leading-relaxed">
            <section>
              <h2 className="text-white font-semibold text-base mb-2">1. 수집하는 개인정보</h2>
            ...
            <section>
              <h2 className="text-white font-semibold text-base mb-2">2. 수집 목적</h2>
            ...
            <section>
              <h2 className="text-white font-semibold text-base mb-2">3. 제3자 제공</h2>
            ...
            <section>
              <h2 className="text-white font-semibold text-base mb-2">4. 보유 및 이용 기간</h2>
              <ul className="list-disc list-inside space-y-1 text-white/70">
            ...
            <section>
              <h2 className="text-white font-semibold text-base mb-2">5. 이용자의 권리</h2>
            ...
            <section>
              <h2 className="text-white font-semibold text-base mb-2">6. 연락처</h2>
              <p className="text-white/70">
                개인정보 관련 문의: <span className="text-purple-300">snix.kr@gmail.com</span>
              </p>
            </section>

            <section>
              <h2 className="text-white font-semibold text-base mb-2">7. 시행일</h2>
              <p className="text-white/70">본 방침은 2025년 1월 1일부터 시행됩니다.</p>
            </section>
          </div>
        </div>
